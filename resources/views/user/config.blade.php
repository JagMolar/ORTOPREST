    ...
    <div class="row justify-content-center" style="padding-top: 50px">
        ...
        <div class="col-md-5">
            ...
            <div class="card pt-6 shadow rounded">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" aria-label="Actualización Perfil Usuario">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surname1" type="text" class="form-control{{ $errors->has('surname1') ? ' is-invalid' : '' }}" name="surname1" value="{{  Auth::user()->surname1  }}" required autofocus>
